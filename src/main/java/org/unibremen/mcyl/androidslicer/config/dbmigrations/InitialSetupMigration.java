...
public class InitialSetupMigration {
    ...
    /*
      sources: 
      https://github.com/wala/WALA/blob/096e2f796f3351bf7c4f296ccd23b6fc98983d40/com.ibm.wala.core/src/com/ibm/wala/ipa/callgraph/AnalysisOptions.java#L80
    ...
    */
    ...
    public void addSlicerOptions(MongoTemplate mongoTemplate) {
        ...
        reflectionOption_NO_FLOW_TO_CASTS_NO_METHOD_INVOKE.setDescription("Analyzes no flows from newInstance() calls to casts and ignores calls to Method.invoke().");
        ...
        reflectionOption_NO_METHOD_INVOKE.setDescription("Analyzes Integer.MAX_VALUE flows from newInstance() calls to casts and ignores calls to Method.invoke().");
        ...
        reflectionOption_NO_STRING_CONSTANTS.setDescription("Analyzes Integer.MAX_VALUE flows from newInstance() calls to casts and ignores calls to reflective methods with String constant arguments.");
        ...
        reflectionOption_NONE.setDescription("Analyzes no flows from newInstance() calls to casts and ignores calls to Method.invoke() and ignores calls to reflective methods with String constant arguments.");
        ...
        reflectionOption_FONE_FLOW_TO_CASTS_NO_METHOD_INVOKE.setDescription("Analyzes one flow from newInstance() calls to casts and and ignores calls to Method.invoke().");
        ...
        dataDependenceOptions_FULL.setDescription("Tracks all data dependencies. Produces the largest SDG and uses the most computing resouces.");
        ...
        dataDependenceOptions_NO_BASE_NO_EXCEPTIONS.setDescription("Like FULL, but ignore data dependence edges that define base pointers for indirect memory access and ignore all data dependence edges to/from throw and catch statements.");
        ...
        dataDependenceOptions_NO_BASE_NO_HEAP.setDescription("Like NO_BASE_PTS, and additionally ignore all data dependence edges to/from heap locations.");
        ...
        dataDependenceOptions_NO_BASE_NO_HEAP_NO_EXCEPTIONS.setDescription("Like FULL, but ignore data dependence edges that define base pointers for indirect memory access and ignore all data dependence edges to/from heap locations and ignore all data dependence edges to/from throw and catch statements.");
        ...
        dataDependenceOptions_NO_BASE_PTRS.setDescription("Like FULL, but ignore data dependence edges that define base pointers for indirect memory access.");
        ...
        dataDependenceOptions_NO_EXCEPTIONS.setDescription("Like FULL, ignore all data dependence edges to/from throw and catch statements.");
        ...
        dataDependenceOptions_NO_HEAP.setDescription("Like FULL, and additionally ignore all data dependence edges to/from heap locations.");
        ...
        dataDependenceOptions_NO_HEAP_NO_EXCEPTIONS.setDescription("Like FULL, and additionally ignore all data dependence edges to/from heap locations and ignore all data dependence edges to/from throw and catch statements.");
        dataDependenceOptions_NO_HEAP_NO_EXCEPTIONS.setIsDefault(true);
        ...
        dataDependenceOptions_NONE.setDescription("Ignore all data dependencies. Produces the smallest SDG and uses the least computing resouces.");
        ...
        controlDependenceOptions_NO_EXCEPTIONAL_EDGES.setDescription("Data dependencies transmitted via exception objects will be ignored.");
