...
describe('Slice e2e test', () => {
  ...
  /* it('should create and save Slice', async () => {
        ...
        expect(await sliceUpdatePage.getAndroidClassNameInput()).to.eq('androidClassName', 'Expected AndroidClassName value to be equals to androidClassName');
        ...
        expect(await sliceUpdatePage.getSeedStatementsInput()).to.eq('seedStatements', 'Expected SeedStatements value to be equals to seedStatements');
  ...
  /* it('should delete last Slice', async () => {
        ...
        expect(await sliceDeleteDialog.getDialogTitle())
            .to.eq('Are you sure you want to delete this Slice?');
